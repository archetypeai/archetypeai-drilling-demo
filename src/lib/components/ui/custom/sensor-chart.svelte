...
>
	<p class="text-muted-foreground text-[10px]">
		Volve oil field, North Sea (Equinor, 2007-2009 drilling phase) · Drilling rig surface sensors · Newton classifies each 100-sample window as drilling (bit cutting rock) or not drilling (tripping, circulating, shut-in)
	</p>
